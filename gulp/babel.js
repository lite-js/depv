...
(0, _zeroLang.each)(_config.scriptDirs, function (dir) {
    _gulp2.default.task((0, _sprintf2.default)('babel-%s', dir), function () {
        return _gulp2.default.src((0, _path.resolve)(__dirname, (0, _sprintf2.default)('../%s/**/*.es6', dir))).pipe((0, _gulpBabel2.default)({
            presets: ['es2015']
        })).on('error', console.error.bind(console)).pipe((0, _gulpRename2.default)(function (path) {
            path.extname = '.js';
